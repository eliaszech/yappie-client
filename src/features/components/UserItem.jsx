...
function UserItem({user, serverMember = null, color = '', paddings = 'px-2 py-1', dimOffline = false}) {
    ...
    const dimmed = dimOffline && !online;
    ...
    return (
        <div className={`cursor-pointer flex items-center gap-3 ${paddings} rounded-md hover:bg-border transition duration-200 ${dimmed ? 'opacity-40 hover:opacity-100' : ''}`}>
