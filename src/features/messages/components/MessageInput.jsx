...
import {faFaceSmile, faPlus} from "@awesome.me/kit-95376d5d61/icons/classic/regular";
...
function MessageInput({roomName, type = 'conversation', roomId}) {
    ...
    function sendMessage() {
        ...
        socket.emit('message:send', { type, roomId, text: input });
        setInput('');
    }
    ...
    return (
        <div className="relative flex flex-col px-1.5 pb-2 z-3">
            ...
            <div className="flex items-center relative">
                ...
                <input type="text" className="w-full pl-12 pr-12 h-[56px] text-foreground placeholder:text-muted-foreground! border border-border outline-none rounded-lg shadow-sm bg-card focus:ring-2 focus:ring-primary/80 transition-colors"
