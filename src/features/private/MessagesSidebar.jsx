                ...
                <div className="flex flex-col gap-1">
                    {conversations.map((conversation) => {
                        ...
                        return <NavLink to={`/messages/${conversation.id}`} key={conversation.id}
                             className="">
                            <div className="w-full flex items-center gap-2.5 px-2 py-2 rounded-md font-medium transition-all text-foreground/80 hover:text-foreground hover:bg-muted/50 ">
                                <div
                                    className="w-7 h-7 rounded-full flex items-center justify-center text-[10px] font-bold text-primary-foreground bg-primary">
