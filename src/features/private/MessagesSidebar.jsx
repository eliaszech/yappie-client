...
function MessagesSidebar() {
    ...
    return(
        <div className="max-w-xs min-w-xs w-full shrink-0 bg-card rounded-tl-xl flex flex-col grow overflow-y-auto pb-[65px]">
            <div className="px-3 h-12 flex items-center border-b-2 border-border shrink-0">
                <a href="#findOrStart"
